...
function shoeSize('players') {
    console.log(home.teamName.players.shoeSize);
}

function teamColors('teamName') {
    console.log(teamName.colors);
}
...
function playerNumbers(players) {
    console.log(home.teamName.players);
...
function bigShoeRebounds('Mason Plumlee') {
    return(rebounds);
}

function mostPointsScored('Ben Gordon') {
    return(points);
}
